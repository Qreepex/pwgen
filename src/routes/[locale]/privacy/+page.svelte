...
<div class="w-full flex flex-wrap justify-center my-2">
	<div class="w-5/6 lg:w-2/3">
		<div class="py-4">
			<h1>{@html t('privacy')}</h1>

			<p>TL;DR: We don't sell your personal data and CANNOT read your generated passwords.</p>

			<h2>1. An overview of data protection</h2>
			<h3>General information</h3>
			<p>
				The following information will provide you with an easy to navigate overview of what will
				happen with your personal data when you visit this website. The term &ldquo;personal
				data&rdquo; comprises all data that can be used to personally identify you. For detailed
			...
			<p>
				...
				reliable depiction of our website possible. If appropriate consent has been obtained, the
				processing is carried out exclusively on the basis of Art. 6(1)(a) GDPR and &sect; 25 (1)
				TDDDG, insofar the consent includes the storage of cookies or the access to information in
				the user&rsquo;s end device (e.g., device fingerprinting) within the meaning of the TDDDG.
			...
			<p>
				...
				with your IP addresses. For details, please consult the data privacy policy of IONOS: <a
			...
			<p>
				...
				obtained, the processing is carried out exclusively on the basis of Art. 6(1)(a) GDPR and
				&sect; 25 (1) TDDDG, insofar the consent includes the storage of cookies or the access to
				information in the user&rsquo;s end device (e.g., device fingerprinting) within the meaning
			...
			<h3>Cloudflare</h3>
			<p>
				We use the &ldquo;Cloudflare&rdquo; service provided by Cloudflare Inc., 101 Townsend St.,
				San Francisco, CA 94107, USA. (hereinafter referred to as &ldquo;Cloudflare&rdquo;).
			</p>
			<p>
				Cloudflare offers a content delivery network with DNS that is available worldwide. As a
				result, the information transfer that occurs between your browser and our website is
				technically routed via Cloudflare&rsquo;s network. This enables Cloudflare to analyze data
				transactions between your browser and our website and to work as a filter between our
				servers and potentially malicious data traffic from the Internet. In this context,
				Cloudflare may also use cookies or other technologies deployed to recognize Internet users,
			...
			<p>
				...
				European Commission. Details can be found here: <a
			...
			<p>
				For more information on Cloudflare&rsquo;s security precautions and data privacy policies,
			...
			<p>
				...
				standards. For more information, please contact the provider under the following link: <a
			...
			<h3>
				Information about the responsible party (referred to as the &ldquo;controller&rdquo; in the
				GDPR)
			</h3>
			...
			<p>
				...
				device fingerprinting), the data processing is additionally based on &sect; 25 (1) TDDDG.
				The consent can be revoked at any time. If your data is required for the fulfillment of a
			...
			<h3>Cookies</h3>
			<p>
				Our websites and pages use what the industry refers to as &ldquo;cookies.&rdquo; Cookies are
				small data packages that do not cause any damage to your device. They are either stored
				temporarily for the duration of a session (session cookies) or they are permanently archived
				on your device (permanent cookies). Session cookies are automatically deleted once you
				terminate your visit. Permanent cookies remain archived on your device until you actively
			...
			<p>
				...
				technically error-free and optimized provision of the operator&rsquo;s services. If your
				consent to the storage of the cookies and similar recognition technologies has been
				requested, the processing occurs exclusively on the basis of the consent obtained (Art.
			...
			<p>Besides Cloudflare, we only use cookies to store your settings (like length or whether to inlclude numbers and symbols) encoded as base64 - NOT your generated passwords - locally on your device if you have chosen to do so. We CANNOT read your cookies, local storage, or generated passwords.</p>
			...
			<p>
				...
				operator&rsquo;s website. In order to achieve this, server log files must be recorded.
			</p>
